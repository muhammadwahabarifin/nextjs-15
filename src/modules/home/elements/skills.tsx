    ...
    return (
        <section id='skills' className='w-full px-[5%] flex flex-col gap-5'>
            <div className="relative flex flex-col items-center">
                <div className="absolute -right-[200px] top-[400px] hidden h-[400px] w-[400px] rounded-full bg-pink-200 opacity-70 blur-3xl md:block"></div>
                <div className="absolute -right-[200px] top-0 hidden h-[500px] w-[800px] rounded-full bg-blue-200 opacity-70 blur-3xl md:block"></div>
                <div className="flex gap-3 md:items-center">
                    ...
                    <div className="flex flex-col">
                        ...
                        <Fade
                            ...
                            damping={0.2}
                            triggerOnce>
                            <p className="md:text-xl text-center text-zinc-400">This my skills in software engineering.</p>
                        </Fade>
                    </div>
                </div>
            </div>
