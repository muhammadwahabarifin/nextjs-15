    ...
    return (
        <section id='skills' className='w-full px-[5%] flex flex-col gap-5'>
            <div className="relative flex flex-col items-center">
                <div className="absolute -left-[200px] top-[400px] hidden h-[400px] w-[400px] rounded-full bg-pink-200 opacity-70 blur-3xl md:block"></div>
                <div className="absolute -left-[200px] top-0 hidden h-[500px] w-[800px] rounded-full bg-blue-200 opacity-70 blur-3xl md:block"></div>
                <div className="flex gap-3 md:items-center">
                    ...
                    <div className="flex flex-col">
                        <div className="flex gap-4">
                            <h2 className="text-2xl font-semibold md:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-purple-600">My Stack</h2>
            ...
            <div className='flex flex-col gap-7 my-8'>
                <h1 className='text-2xl flex gap-3 font-semibold text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-purple-600'>
               ...
               p-5 rounded-xl flex flex-col gap-5 md:hover:scale-105 md:duration-300 backdrop-blur-md shadow-2xl shadow-blue-200'>
